...
static const float bordercolor[]           = COLOR(0x525e54ff);
static const float focuscolor[]            = COLOR(0x9efd38ff);
static const float urgentcolor[]           = COLOR(0xed2939ff);
...
static const Rule rules[] = {
	...
	{ "Gimp",     NULL,       0,            1,           -1 },
	*/
	{ "firefox",  NULL,       1 << 0,       0,           -1 },	{ "firefox",  NULL,       1 << 0,       0,           -1 },
	{ "Gimp",     NULL,       1 << 2,       1,          -1 },
	{ "virt-manager", NULL,   1 << 4,       0,          -1 },
	{ "gedit",    NULL,       1 << 1,       0,          -1 },
	{ "gcolor3",  NULL,       0,            1,          -1},
	{ "pcmanfm",  NULL,       1 << 1,       0,          -1 },
    { "viewnior", NULL,       1 << 2,       1,          -1 },
    { "onlyoffice", NULL,     1 << 3,       1,          -1 },	
};
...
static const MonitorRule monrules[] = {
	...
	*/
	/* defaults */
	{ NULL,       0.63, 1,      1,    &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL,   -1,  -1 },
};
...
static const char *menucmd[] = { "rofi", "-config", "~/.config/rofi.old/config.rasi","-show", "drun", "-modi", "drun", NULL };
...
static const char *autostart[] = { "sh", "-c", "~/scripts/startdwl", NULL };

static const Key keys[] = {
	/* Note that Shift changes certain key codes: c -> C, 2 -> at, etc. */
	/* modifier                  key                 function        argument */
	{ MODKEY,                    XKB_KEY_p,          spawn,          {.v = menucmd} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_Return,     spawn,          {.v = terminal} },
	{ WLR_MODIFIER_ALT|WLR_MODIFIER_SHIFT, XKB_KEY_Return,  spawn,   {.v = termcmd} },
	{ MODKEY,		     XKB_KEY_F1,         spawn,          {.v = autostart} },
